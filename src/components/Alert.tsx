...
export const Alert: React.FC<AlertProps> = ({
  ...
  return (
    <div
      className={`rounded-md border ${styles.border} ${styles.bg} p-4 ${className}`}
      role="alert"
    >
      <div className="flex">
        ...
        <div className="ml-3 flex-1">
          ...
          {messageList.length === 1 ? (
            ...
            <ul className={`text-sm ${styles.text} mt-1`}>
        ...
        {onDismiss && (
          <div className="ml-auto pl-3">
            <button
              type="button"
              onClick={onDismiss}
              className={`inline-flex rounded-md p-1.5 ${styles.text} hover:${styles.bg} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-red-50 focus:ring-red-600`}
            >
